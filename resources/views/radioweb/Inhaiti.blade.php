...
<head>
    ...
    <style>
        ...
        .bgimg-1 {
            ...
            background-image: url("https://impactsansfrontieres.com/wp-content/uploads/2023/04/haiti.jpeg");
            min-height: 100%;
        }
...
<header class="bgimg-1 w3-display-container w3-grayscale-min" id="home">
    <div class="w3-display-left w3-text-white" style="padding:48px">
        <span class="w3-jumbo w3-hide-small">IN HAITI</span><br>
        <span class="w3-xxlarge w3-hide-large w3-hide-medium">IN HAITI</span><br>
        <span class="w3-large">
    ...
    <div class="w3-row-padding w3-center" style="margin-top:64px">
        ...
        <div class="w3-container w3-light-grey" style="padding:128px 16px">
            ...
            <div class="w3-row-padding">
                <div class="w3-col m6">
                    <a href="{{route('evangelisation')}}"><h3>Campagne in HAÏTI 2018</h3></a>

                    <img class="w3-image w3-round-large" src="/img/26233578_587886978214599_3607488209309445837_o.jpg" alt="Buildings" width="700" height="394">

                    <button class="btn  " style="background-color: green"><a href="{{route('commentparticiper')}}">REJOINDRE LA MISSION</a></button>
                ...
                <div class="w3-col m6">
                    ...
                    <h3></h3>
                    <button class="btn  " style="background-color: green"><a href=""></a></button>
                    <p>IN Haïti n’était pas uniquement une campagne d’évangélisation avec manifestations d’œuvres de compassion, c’était d’abord une mission spirituelle de libération d’un pays porteur d’énormes promesses mais que Satan tenait lié depuis son indépendance.</p>
                    <p>Les Haïtiens, autorités politiques et clergés sont tous unanimes pour reconnaître que jamais tel rassemblement n’a eu lieu dans le pays. Il y a eu comme une unité nationale spirituelle autour de cette campagne, les Haïtiens ont en avaient assez de cette malédiction et criaient « Assez, c’est assez ! ». Cette campagne a été la réponse de Dieu et Il a prouvé qu’il avait commandé Lui-même cette mission par une mobilisation divine sans précédent.</p>
                    <p>Merci à Dieu pour tous les missionnaires qui sont venus avec moi, avec pasteur Mohammed SANOGO et avec pasteur Gregory Toussaint.</p>
                    <p>En collaboration avec les églises Impact Centre Chrétien (ICC), VASE D’HONNEUR et TABERNACLE DE GLOIRE qui ont puisé sur leurs fonds propres pour financer cette campagne car les dons financiers étaient en réalité insuffisants pour couvrir le budget.</p>
                    <p>Merci à tous ceux qui ont apporté une assistance matérielle en dons ou une contribution financière. Rien n’a été négligeable, tout a été utilisé à bon escient.</p>
