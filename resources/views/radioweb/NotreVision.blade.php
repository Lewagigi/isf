      ...
      <source src="rain.mp4" type="video/mp4">
        ...
        <div class="row">
            <div class="column" style="background-color:;">
                <h2>VISION DE LA WEB RADIO</h2>
                <p>La webradio Impact Sans Frontières est une radio chrétienne évangélique. Elle est rattachée à Impact Sans Frontières, qui est sous la responsabilité du Pasteur André AMBEDET. Cette plateforme est dédiée à l’évangélisation à travers le monde francophone 24h/24H & 7J/7J.

                    Notre objectif est de rendre la Bonne Nouvelle accessible à TOUS jusqu’aux extrémités de la terre et permettre à chacun de rencontrer Celui qui transforme réellement les vies :  Jésus-Christ.

                    Même si le monde entier vous tourne le dos et peu importe ce que vous avez entendu jusqu’à présent sachez que Vous êtes une « Merveilleuse créature » et que vous avez de la Valeur aux yeux de Dieu …Oui oui vous êtes la « Prunelle de ses yeux ». N’en doutez plus.

                    Nous sommes là pour vous accompagner tout au long de ce processus dans votre « Nouveau départ » avec Jésus-Christ.</p>
            </div>
