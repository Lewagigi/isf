...
<head>
    ...
    <style>
        ...
        .bgimg-1 {
            ...
            background-image: url("https://impactsansfrontieres.com/wp-content/uploads/2023/03/WhatsApp-Image-2023-03-25-at-12.47.29.jpeg");
            min-height: 100%;
        }
    ...
    <div class="w3-row-padding w3-center" style="margin-top:64px">
        ...
        <div class="w3-container w3-light-grey" style="padding:128px 16px">
            ...
            <div class="w3-row-padding">
                <div class="w3-col m6">
                    <a href=""><h3>CAP MADAGASCAR</h3></a>
                    <button class="btn  " style="background-color: green"><a href=""></a></button>
                    <img class="w3-image w3-round-large" src="/img/" alt="" width="700" height="394">
