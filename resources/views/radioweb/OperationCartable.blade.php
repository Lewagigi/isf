...
<head>
    ...
    <style>
        ...
        .bgimg-1 {
            ...
            background-image: url("https://impactsansfrontieres.com/wp-content/uploads/2023/03/311583322_1755823568126314_4313470945988575308_n.jpg");
            min-height: 100%;
        }
...
<header class="bgimg-1 w3-display-container w3-grayscale-min" id="home">
    <div class="w3-display-left w3-text-white" style="padding:48px">
        <span class="w3-jumbo w3-hide-small">CAP MADAGASCAR</span><br>
        <span class="w3-xxlarge w3-hide-large w3-hide-medium">CAP MADAGASCAR</span><br>
        <span class="w3-large">
    ...
    <div class="w3-row-padding w3-center" style="margin-top:64px">
        ...
        <div class="w3-container w3-light-grey" style="padding:128px 16px">
            ...
            <div class="w3-row-padding">
                <div class="w3-col m6">
                    <a href=""><h3>OPERATION CARTABLE</h3></a>
                    <h3>C'est quoi l'Opération Cartable ?</h3>

                    <p>L’opération Cartable consiste à prendre en charge, chaque années : les frais de scolarité, les fournitures scolaires et les tenues vestimentaires d’environ 250 orphelins et enfants démunis dans les villes suivantes : </p>
                    <h5>Douala – Bamako – Cotonou </h5>
                    <h5>Port-au-Prince – Parakou – Yaoundé  </h5>
                    <h5> Lomé –Porto- Novo, Kinshasa. </h5>
                ...
                <div class="w3-col m6">
                    ...
                    <h3>En route pour 2024 !</h3>
                    <button class="btn  " style="background-color: green"><a href=""></a></button>
                    <img class="w3-image w3-round-large" src="/img/WhatsApp-Image-2023-08-08-at-21.27.17.jpeg" alt="" width="700" height="394">
...
<div class="w3-row-padding w3-grayscale" style="margin-top:64px">
    <div class="w3-col l3 m6 w3-margin-bottom">
        <div class="w3-card">
            ...
            <div class="container">
                <button class="btn  " style="background-color: green ; position: relative; left: 120px"><a href="">Cliquez ICI</a></button>
            </div>
        </div>
    </div>
    <div class="w3-col l3 m6 w3-margin-bottom">
