...
<head>
    ...
    <style>
        ...
        .bgimg-1 {
            ...
            background-image: url("https://impactsansfrontieres.com/wp-content/uploads/2023/06/244179440_1487234068318600_3449500436247421668_n.jpg");
            min-height: 100%;
        }
...
<header class="bgimg-1 w3-display-container w3-grayscale-min" id="home">
    <div class="w3-display-left w3-text-white" style="padding:48px">
        <span class="w3-jumbo w3-hide-small">COMMENT PARTICIPER ?</span><br>
        <span class="w3-xxlarge w3-hide-large w3-hide-medium">COMMENT PARTICIPER ?</span><br>
        <span class="w3-large">
        ...
        <div class="w3-container w3-light-grey" style="padding:128px 16px">
            ...
            <div class="w3-row-padding">
                <div class="w3-col m6">
                    ...
                    <img class="w3-image w3-round-large" src="/img/IMG-20210521-WA0076.jpg" alt="Buildings" width="700" height="394">

                    <p>Participer à nos campagne d’évangelisation et autres actions en cliquant sur le bouton ci-dessous.</p>
                    <button class="btn  " style="background-color: green"><a href="{{route('nosactions')}}">Cliquez ICI</a></button>
                    <h3>DEVENIR BENOVOLE</h3>
                    ...
                    <p>Ecrivez-nous à contact@impactsansfrontières.com</p>
                    <button class="btn  " style="background-color: green"><a href="">Cliquez ICI</a></button>
                    <p>
                    <h4>
                        <a href="" class=""></a>
                ...
                <div class="w3-col m6">
                    ...
                    <h3>PARLER DE NOUS</h3>


                    <img class="w3-image w3-round-large" src="/img/ISF-BANNER-1.webp" alt="Buildings" width="700" height="394">

                    <p>Partagez nos actions sur les réseaux sociaux, parlez de nous autour de vous.</p>
                    <button class="btn  " style="background-color: green"><a href="{{route('capsurlemali')}}">Cliquez ICI</a></button>
...
<div class="w3-container w3-light-grey" style="padding:128px 16px" id="contact">
    ...
    <div style="margin-top:48px">
        ...
        <p><i class="fa fa-envelope fa-fw w3-xxlarge w3-margin-right"> </i> Mail : contact@impactsansfrontieres.com</p>
        <br>
