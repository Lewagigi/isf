...
<head>
    ...
    <style>
        ...
        .bgimg-1 {
            ...
            background-image: url("https://impactsansfrontieres.com/wp-content/uploads/2023/06/336379029_516649307214266_3321800699068308307_n-3.jpg");
            min-height: 100%;
        }
...
<div class="w3-container w3-light-grey" style="padding:128px 16px">
    ...
    <h3 class="w3-center">EVANGELISATION</h3>
    ...
    <div class="w3-row-padding w3-grayscale" style="margin-top:64px">
        <div class="w3-col l3 m6 w3-margin-bottom">
            <div class="w3-card">
                ...
                <img src="/img/WhatsApp-Image-2023-03-28-at-21.17.30-1-1.jpeg" alt="" style="width:100%">
                <div class="w3-container">
                    <h3></h3>
                    <button class="btn  " style="background-color: green;position: relative; left: 100px"><a href="{{route('capsurlemali')}}">Cliquez ICI</a></button>
        ...
        <div class="w3-col l3 m6 w3-margin-bottom">
            <div class="w3-card">
                <h3><a href="{{route('inhaiti')}}"></a> </h3>
                <img src="/img/26233578_587886978214599_3607488209309445837_o.jpg" alt="" style="width:100%">
                <div class="w3-container">
                    <h3></h3>
                ...
                <div class="container">
                    <button class="btn  " style="background-color: green ; position: relative; left: 110px"><a href="{{route('inhaiti')}}">Cliquez ICI</a></button>
                </div>
            </div>
        </div>
        <div class="w3-col l3 m6 w3-margin-bottom">
            <div class="w3-card">
                <h3><a href="{{route('capsurmadagascar')}}"></a> </h3>
                <img src="/img/WhatsApp-Image-2023-03-25-at-12.47.29.jpeg" alt="" style="width:100%">
                <div class="w3-container">
                    <h3></h3>

                </div>
                <div class="container">
                    <button class="btn  " style="background-color: green; position: relative; left: 110px"><a href="{{route('capsurmadagascar')}}">Cliquez ICI</a></button>
                </div>
            </div>
