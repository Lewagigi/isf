    ...
    <div class="w3-row-padding w3-center" style="margin-top:64px">
        ...
        <div class="w3-container w3-light-grey" style="padding:128px 16px">
            ...
            <div class="w3-row-padding">
                <div class="w3-col m6">
                    <a href="{{route('evangelisation')}}"><h3>CAMPAGNE D'EVANGELISATION</h3></a>
                    <button class="btn  " style="background-color: green"><a href="{{route('evangelisation')}}">EN SAVOIR PLUS..</a></button>
                    <img class="w3-image w3-round-large" src="/img/31388E22-1D80-425C-81E8-93FAE6AFA959.png" alt="Buildings" width="700" height="394">


                    <a href="{{route('actesdecompassion')}}"><h3>ACTES DE COMPASSION</h3></a>
                    <button class="btn  " style="background-color: green"><a href="{{route('actesdecompassion')}}">EN SAVOIR PLUS..</a></button>
                ...
                <div class="w3-col m6">
                    ...
                    <h3>IMPLANTATION DES EGLISES</h3>
                    <button class="btn  " style="background-color: green"><a href="">EN SAVOIR PLUS..</a></button>
